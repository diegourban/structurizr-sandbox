...
/**
 * A "getting started" example that illustrates how to create a software
 * architecture diagram using code.
 *
 * The live workspace is available to view at
 * https://structurizr.com/share/25441
 */
public class GettingStarted {
	...
	public static void main(String[] args) throws Exception {
		...
		// upload to structurizr.com (you'll need your own workspace ID, API key and API
		// secret)
